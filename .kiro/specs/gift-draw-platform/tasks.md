...
- [x] 1. Set up Django backend project structure
  - [x] 1.1 Initialize Django project and app inside the repo (e.g., `backend/` directory with `manage.py`, `config/` settings, and a `core` app)
  ...
  - [x] 1.2 Define data models: Ticket, DrawResult, Admin (User)
...
- [x] 2. Implement ticket management API endpoints
  - [x] 2.1 Implement ticket creation endpoint (`POST /api/tickets`)
  ...
  - [x] 2.2 Implement ticket listing and detail endpoints (`GET /api/tickets`, `GET /api/tickets/:id`)
  ...
  - [x] 2.3 Implement ticket cancellation endpoint (`PATCH /api/tickets/:id/cancel`)
  ...
  - [x] 2.4 Implement folio reassignment endpoint (`POST /api/tickets/:id/reassign`)
  ...
  - [x] 2.5 Write property tests for ticket lifecycle
  ...
  - [x] 2.6 Write unit tests for ticket API endpoints
    - Test create, list, detail, cancel, reassign flows including error cases
    - _Requirements: 1.1, 2.1, 2.2, 3.1, 3.2, 4.1, 4.2_

- [x] 3. Implement admin authentication
  - [x] 3.1 Implement login endpoint (`POST /api/auth/login`) and auth middleware
  ...
  - [x] 3.2 Create initial admin users via Django management command or fixture
    - Ensure passwords are stored hashed (Django default behavior)
    - _Requirements: 10.1, 11.5_

  - [x] 3.3 Write property tests for authentication enforcement
...
- [x] 4. Checkpoint — Backend ticket management and auth
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Implement draw engine and execution API
  - [x] 5.1 Implement Draw Engine as an isolated module
  ...
  - [x] 5.2 Implement draw execution endpoint (`POST /api/draw/execute`)
  ...
  - [x] 5.3 Implement public draw results endpoint (`GET /api/draw/results`)
  ...
  - [x] 5.4 Implement dashboard endpoint (`GET /api/dashboard`)
    - Return count of active tickets and total raised (count × $200 MXN)
    - _Requirements: 8.1_

  - [x] 5.5 Write property tests for draw engine
  ...
  - [x] 5.6 Write property tests for public endpoints
...
- [x] 6. Implement ticket file generation
  - [x] 6.1 Implement PDF ticket generator (`GET /api/tickets/:id/download/pdf`)
...
- [x] 7. Add input validation and rate limiting
...
- [x] 8. Checkpoint — Full backend complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 9. Set up React frontend routing and layout
  - [x] 9.1 Install React Router and set up route structure
...
- [x] 10. Implement public website pages
  ...
  - [x] 10.2 Implement About Us page (`/about`)
  ...
  - [x] 10.3 Implement Results page (`/results`)
  ...
  - [x] 10.4 Implement Privacy Notice page (`/privacy`)
...
- [x] 11. Implement admin panel
  ...
  - [x] 11.4 Implement ticket list page (`/admin/tickets`)
  ...
  - [x] 11.5 Implement draw execution page (`/admin/draw`)
  ...
  - [x] 11.6 Write unit tests for admin panel components
